...
# in all other cases search for ar, ranlib, etc.
  ...
  if(CMAKE_C_COMPILER_EXTERNAL_TOOLCHAIN)
    if("${CMAKE_C_COMPILER_EXTERNAL_TOOLCHAIN}" MATCHES ".*/bin\$")
      set(_CMAKE_TOOLCHAIN_LOCATION ${_CMAKE_TOOLCHAIN_LOCATION} ${CMAKE_C_COMPILER_EXTERNAL_TOOLCHAIN})
    else()
      set(_CMAKE_TOOLCHAIN_LOCATION ${_CMAKE_TOOLCHAIN_LOCATION} ${CMAKE_C_COMPILER_EXTERNAL_TOOLCHAIN}/bin)
    endif()
  endif()
  if(CMAKE_CXX_COMPILER_EXTERNAL_TOOLCHAIN)
    if("${CMAKE_CXX_COMPILER_EXTERNAL_TOOLCHAIN}" MATCHES ".*/bin\$")
      set(_CMAKE_TOOLCHAIN_LOCATION ${_CMAKE_TOOLCHAIN_LOCATION} ${CMAKE_CXX_COMPILER_EXTERNAL_TOOLCHAIN})
    else()
