...
if("x${CMAKE_C_SIMULATE_ID}" STREQUAL "xMSVC"
  ...
  macro(__compiler_clang lang)
    ...
    if("${CMAKE_${lang}_COMPILER_EXTERNAL_TOOLCHAIN}" MATCHES ".*/bin\$")
      set(CMAKE_${lang}_COMPILE_OPTIONS_TARGET "--target=")
      set(CMAKE_${lang}_COMPILE_OPTIONS_EXTERNAL_TOOLCHAIN "-B")
    elseif(CMAKE_${lang}_COMPILER_VERSION VERSION_LESS 3.4.0)
      set(CMAKE_${lang}_COMPILE_OPTIONS_TARGET "-target ")
